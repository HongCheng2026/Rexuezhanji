(function registerFeaturePanelContent(root) {
  ...
  const GROWTH_TASKS = [
    ...
    { id: "task_attack_3", bucket: "growth", category: "强化", title: "战机攻击 Lv.3", desc: "将战机攻击强化到 3 级，提升清场效率。", condition: { type: "fighter_upgrade", stat: "attack", target: 3, label: "战机攻击达到 Lv.3" }, rewards: [{ type: "gold", amount: 4000 }] },
