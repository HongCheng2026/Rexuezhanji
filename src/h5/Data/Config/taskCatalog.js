(function registerTaskCatalog(root) {
  ...
  var TASKS = Object.freeze([
    { id: "daily_dossier_check", track: "daily", category: "战备", title: "指挥官点名", desc: "完成今日登录与身份校验。", condition: { type: "login", target: 1, label: "今日登录" }, rewards: [{ type: "gold", amount: 1000 }], activity: 5, priority: 10 },
    { id: "daily_supply_check", track: "daily", category: "补给", title: "补给链校验", desc: "确认星港补给链处于可用状态。", condition: { type: "login", target: 1, label: "完成校验" }, rewards: [{ type: "gold", amount: 1000 }], activity: 5, priority: 20 },
    { id: "daily_sortie_1", track: "daily", category: "作战", title: "首航资格复核", desc: "拥有至少一次通关记录后，每日开放该项补给。", condition: { type: "clear_count", target: 1, label: "累计通关" }, rewards: [{ type: "gold", amount: 2000 }], activity: 10, priority: 30 },
    { id: "daily_sortie_3", track: "daily", category: "作战", title: "巡航资格复核", desc: "累计完成三次通关，取得稳定巡航资格。", condition: { type: "clear_count", target: 3, label: "累计通关" }, rewards: [{ type: "gold", amount: 5000 }], activity: 20, priority: 40 },
    { id: "daily_upgrade_once", track: "daily", category: "整备", title: "机体校准复核", desc: "完成任意一次战机强化，解锁每日整备补给。", condition: { type: "fighter_upgrade_any", target: 1, label: "累计强化" }, rewards: [{ type: "gold", amount: 3000 }], activity: 15, priority: 50 },
    { id: "daily_boss_1", track: "daily", category: "战果", title: "战果档案复核", desc: "拥有正式通关战果后，每日归档一次作战记录。", condition: { type: "clear_count", target: 1, label: "有效战果" }, rewards: [{ type: "gold", amount: 5000 }], activity: 20, priority: 60 },
    { id: "daily_perfect_1", track: "daily", category: "技巧", title: "王牌资格复核", desc: "取得一次完美通关，解锁王牌每日津贴。", condition: { type: "perfect_count", target: 1, label: "完美通关" }, rewards: [{ type: "gold", amount: 8000 }], activity: 25, priority: 70 },
    { id: "daily_gold_10000", track: "daily", category: "回收", title: "回收额度复核", desc: "累计回收一万金币，取得补给调度资格。", condition: { type: "earned_gold", target: 10000, label: "累计回收" }, rewards: [{ type: "energy", amount: 20 }], activity: 15, priority: 80 },
