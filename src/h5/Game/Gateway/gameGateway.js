  ...
  function create(options) {
    ...
    return {
      ...
      upgradeAutoWeaponWithComponents: function upgradeAutoWeaponWithComponents(moduleId, operationId) {
        return callAdapter(adapter, "upgradeAutoWeaponWithComponents", [moduleId, operationId], mode);
      },
      upgradeActiveSkillGrade: function upgradeActiveSkillGrade(shipId, slotIndex, targetGrade, operationId) {
        return callAdapter(adapter, "upgradeActiveSkillGrade", [shipId, slotIndex, targetGrade, operationId], mode);
      },
      upgradePassiveSkill: function upgradePassiveSkill(skillId, operationId) {
        return callAdapter(adapter, "upgradePassiveSkill", [skillId, operationId], mode);
      },
      ...
      starUpPilot: function starUpPilot(pilotId) {
        return callAdapter(adapter, "starUpPilot", [pilotId], mode);
      },
      starUpFighter: function starUpFighter(shipId) {
        return callAdapter(adapter, "starUpFighter", [shipId], mode);
      },
      // Social features
