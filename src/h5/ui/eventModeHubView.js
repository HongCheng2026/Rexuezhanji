(function registerEventModeHubView(root) {
  ...
  function renderPanel(dom, options) {
    ...
    dom.featurePanelSlots.className = "terminal-panel-content event-panel-content feature-v3-content event-mode-content";
    dom.featurePanelSlots.innerHTML = '<section class="event-hub-page" data-event-mode-hub>' +
      ...
      '<header class="event-hub-header"><button type="button" class="event-hub-back" data-feature-back aria-label="返回大厅"><span aria-hidden="true">←</span><strong>返回</strong></button><h2>活动中心</h2><small>EVENT HUB</small></header>' +
