(function registerBattleStorySystem(root) {
  ...
  function getBattleStoryText({ chapterIndex, stageInChapter, key }) { const stageId = getStageId(chapterIndex, stageInChapter); return SPECIAL_STAGE_BATTLE_STORY[stageId]?.[key] || GENERIC_BATTLE_STORY_BY_CHAPTER[chapterIndex]?.[key] || GENERIC_BATTLE_STORY_BY_CHAPTER[1]?.[key] || ""; }
